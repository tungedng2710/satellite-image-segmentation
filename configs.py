...
class Configs():
    def __init__(self):
        ...
        'inceptionv4', 'efficientnet-b0', 'efficientnet-b1', 'efficientnet-b2', 
        ...
        'timm-res2net50_26w_8s', 'timm-res2net50_48w_2s', 'timm-res2net50_14w_8s', 'timm-res2next50',
        ...
        'timm-regnetx_160', 'timm-regnetx_320', 'timm-regnety_002', 'timm-regnety_004', 'timm-regnety_006', 
        'timm-regnety_008', 'timm-regnety_016', 'timm-regnety_032', 'timm-regnety_040', 'timm-regnety_064', 
        'timm-regnety_080', 'timm-regnety_120', 'timm-regnety_160', 'timm-regnety_320', 'timm-skresnet18', 
        ...
        self.model = "MAnet" # MAnet, Unet, DeepLabV3Plus, UnetPlusPlus, PAN
        self.encoder = 'mobilenet_v2' # check out the docstring to get the encoder name
        self.encoder_weights = 'imagenet'
        self.activation = 'softmax2d' # could be None for logits or 'softmax2d' for multiclass
        self.loss = "LovaszLoss" # LovaszLoss, DiceLoss, FocalLoss

        self.class_dict = "data/DeepglobeRoads/label_class_dict.csv"
        self.data_dir = 'data/DeepglobeRoads'
        self.target_objects = 'road' # road or building
        self.sample_folder = "data/demo_gpcp/images_1536"
        self.save = False
